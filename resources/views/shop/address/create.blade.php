...
<div class="max-w-4xl mx-auto px-4 py-8">
    ...
    <div class="flex items-center justify-between mb-8">
        <div>
            <h1 class="text-3xl font-bold text-gray-900 tracking-tight">Tambah Alamat Baru</h1>
            <p class="text-sm text-gray-500 mt-2">Tambahkan alamat baru untuk operasional toko atau pengiriman.</p>
        </div>
            ...
            <div class="p-8 space-y-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="label" value="{{ old('label') }}" 
                                ...
                                placeholder="Contoh: Kantor Utama, Gudang Logistik" required>
                        </div>
                ...
                <div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="bg-red-50/50 p-6 rounded-xl border border-red-100 relative">
                            ...
                            <!-- Hidden Inputs -->
                            <input type="hidden" name="location_id" id="input-location-id" required>
                            <input type="hidden" name="province" id="input-province" required>
                            <input type="hidden" name="city" id="input-city" required>
                            <input type="hidden" name="district" id="input-district" required>
                            <input type="hidden" name="village" id="input-village" required>
                        </div>

                        <!-- Manual Fields (Read Only visuals or editable if needed, but primarily auto-filled) -->
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div>
                                <label class="block mb-2 text-sm font-semibold text-gray-900">Kode Pos <span class="text-red-500">*</span></label>
                                <input type="number" name="postal_code" id="addr_postal" value="{{ old('postal_code') }}" 
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="detail_address" rows="3" 
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-[#EC1C25] focus:border-[#EC1C25] block w-full p-3 transition-shadow placeholder-gray-400" 
                                    placeholder="Nama Jalan, Gedung, No. Rumah, RT/RW, Patokan..." required>{{ old('detail_address') }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex items-center justify-between p-4 bg-gray-50 rounded-xl border border-gray-200">
                    ...
                    <label class="relative inline-flex items-center cursor-pointer">
                        <input type="checkbox" name="is_shop_default" value="1" class="sr-only peer">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const inputVillage = document.getElementById('input-village'); // Kelurahan
