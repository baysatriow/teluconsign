                ...
                <div class="bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                    ...
                    <div class="bg-gray-50 px-6 py-4 border-b border-gray-100 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                        <div class="flex items-center gap-4 text-sm text-gray-600">
                            ...
                            <span class="px-2 py-1 bg-gray-200 rounded text-xs">{{ $order->code }}</span>
                        ...
                        <div class="flex flex-col sm:flex-row gap-6">
                            <div class="flex-grow space-y-4">
                                @foreach($order->items as $item)
                                    <div class="flex gap-4">
                                        <div class="w-16 h-16 bg-gray-100 rounded border border-gray-200 overflow-hidden flex-shrink-0">
                                            <!-- Assuming product relationship exists on item, or fields are stored -->
                                             <img src="https://placehold.co/100" class="w-full h-full object-cover">
                                        </div>
                                        <div>
                                            <h4 class="text-sm font-bold text-gray-900 line-clamp-1">{{ $item->product_title }}</h4>
                            ...
                            <div class="sm:text-right flex flex-col justify-center border-t sm:border-t-0 sm:border-l border-gray-100 pt-4 sm:pt-0 sm:pl-6 min-w-[150px]">
                                ...
                                @if($order->payment_status == 'pending')
                                    <button class="text-xs text-white bg-[#EC1C25] hover:bg-[#c4161e] px-4 py-2 rounded transition-colors">
                                        Bayar Sekarang
                                    </button>
                                @endif
                            </div>
