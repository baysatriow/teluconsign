...
class ShippingServices extends Model
{
    ...
    private $primaryKey = 'shipping_services_id';
    ...
    public function addService(ShippingServices $data): bool
    {
        return $data->save();
    }

    public function updateService(int $id, ShippingServices $data): bool
    {
